...
/****************************************************/
int parent[MAX_TREE]={0};//-1=初始未被使用 >=0:元素
...
int main(void)
{
    ...
    printf("請輸入有哪些數(大於等於零)(以空白或換行鍵隔開):\n");
    printf("(輸入E來顯示當前有哪些代表等價關係的樹,輸入S來分配等價關係)\n");
